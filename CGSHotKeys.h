...
CG_EXTERN void CGSSetHotKeyWithExclusion(CGSConnectionID cid, int uid, short options, short key, int modifierFlags, int exclusion);

CG_EXTERN bool CGSGetHotKey(CGSConnectionID cid, int uid, int *options, short *key, int *modifierFlags);
CG_EXTERN void CGSSetHotKey(CGSConnectionID cid, int uid, int options, short key, int modifierFlags);
